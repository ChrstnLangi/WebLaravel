...
<header>
    <div style="background-image: url('@if (isset($page->Gambar->where('background', 1)->first()->img)){{ '/storage/' . $page->Gambar->where('background', 1)->first()->img }}@endif'); background-size: cover;background-repeat: no-repeat; background-position: center;" class = "img-fluid">
  ...
  @else
  <header>
    <div style="background-image: url('@if (isset($page->Gambar->where('background', 1)->first()->img)){{ '/storage/' . $page->Gambar->where('background', 1)->first()->img }}@endif'); background-size: cover; background-position:center;background-repeat: no-repeat">
                  ...
                  <div class="homepage-header_content">
                    <div data-w-id="5fb4b4db-d69c-5d88-8c1a-2cd78f94baf3" style="opacity:0;-webkit-transform:translate3d(0, 60px, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0);-moz-transform:translate3d(0, 60px, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0);-ms-transform:translate3d(0, 60px, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0);transform:translate3d(0, 60px, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0)" class="homepage-header_heading-wrapper">
                      <h1 class="homepage_header_heading" style="padding-top: 20%">@if(isset($page->Text[0]->text)){!! $page->Text[0]->text !!}@endif<div>
                          <div style="margin-right: 320px; background-color : #ffb703; border-radius : 20px; padding: 0% 3%;"class="heading-highlight">
    ...
    <div class="background-webinar" id="our-programs">
      ...
      <img style ="width:75%" class="rounded mx-auto d-block" src="@if (isset($page->Gambar->where('background', 0)->skip(1)->first()->img)){{ '/storage/' . $page->Gambar->where('background', 0)->skip(1)->first()->img }}@endif" alt="webinar" class="rounded mx-auto d-block">
      ...
      <div style="margin: 0px 40%;">
        <div data-w-id="c3733106-a61e-156e-654f-c21c9b4597c8" class="margin-top margin-medium is-custom-margin" style="display: block; margin: auto; padding-bottom: 5%;"><a href="/pendaftaran/create" data-w-id="c3733106-a61e-156e-654f-c21c9b4597c9" style="display: block; margin: auto;text-transform: capitalize; :0;-webkit-transform:translate3d(0, 60px, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0);-moz-transform:translate3d(0, 60px, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0);-ms-transform:translate3d(0, 60px, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0);transform:translate3d(0, 60px, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0); font-size: 130%; margin-left:0%; padding: 20px 60px;" class="button_program w-button">
            Daftar
        </a></div>
      </div>
  ...
  <div style="background-image: url('@if (isset($page->Gambar->where('background', 1)->skip(1)->first()->img)){{ '/storage/' . $page->Gambar->where('background', 1)->skip(1)->first()->img }}@endif'); padding: 10%; background-size: cover; background-position:center;background-repeat: no-repeat">
      ...
      <div id="carouselExampleControlsNoTouching" class="carousel slide" data-bs-touch="false">
          <div class="carousel-inner">
            <div class="carousel-item active">
              <img style ="width:70%" src="@if(isset($page->Gambar->where('background', 0)[1]->img )){{ '/storage/' . $page->Gambar->where('background', 0)[1]->img }}@endif" class="img-fluid mx-auto d-block" alt="...">
            </div>
