...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
  ...
  <form method="post" action="/dashboard/ourSpeaker/{{ $our->id }}" enctype="multipart/form-data">
    @method('put')
    @csrf
    ...
    <div class="mb-3">
      ...
      <div class="mb-3">
        ...
        <select class="form-select" name='speaker_id'>
            ...
            @if (old('speaker_id', $our->speaker_id)== $speaker->id)
    ...
    <div class="mb-3">
        ...
        <input id="text" type="hidden" name="text" value="{{ old('text', $our->text) }}">
