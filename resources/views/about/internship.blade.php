...
@section('contain')
<header>
<div style="background-image: url('@if (isset($page->Gambar->where('background', 1)->first()->img)){{ '/storage/' . $page->Gambar->where('background', 1)->first()->img }}@endif'); background-size: cover; background-position:center; padding-bottom: 150px;">
            ...
            <div id="w-node-c3733106-a61e-156e-654f-c21c9b4597c1-2897c137" class="homepage-header_content-wrapper" style="max-width: 100%;">
              <div class="homepage-header_content" style="max-width: 100%;">
                <div data-w-id="5fb4b4db-d69c-5d88-8c1a-2cd78f94baf3" style="max-width: 100%; opacity:0;-webkit-transform:translate3d(0, 60px, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0);-moz-transform:translate3d(0, 60px, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0);-ms-transform:translate3d(0, 60px, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0);transform:translate3d(0, 60px, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0)" class="homepage-header_heading-wrapper">
                  <h1 class="homepage_header_heading" style="font-size: 55px; max-width: 100%;"><span style="color:white; font-family: 'MontserratSemiBold';" >@if(isset($page->Text[0]->text)){!! $page->Text[0]->text !!}@endif</span></h1>
                </div>
        ...
        <div class="padding-vertical padding-xhuge">
            <div class="margin-bottom margin-xlarge">
              <div class="text-align-center" style="margin: 0 6%;">
                <h2 class="homepage_header_heading text-center"><span style="color:black">@if(isset($page->Text[2]->text)){!! $page->Text[2]->text !!}@endif</span></h2>
...
<div>
    <div class="section-review" style="background-image: url('@if (isset($page->Gambar->where('background', 1)->skip(1)->first()->img)){{ '/storage/' . $page->Gambar->where('background', 1)->skip(1)->first()->img }}@endif'); background-size: cover; background-position:center;">
        <div class="page-padding" style = "
        width: 100%;
        max-width: 77rem;
        margin-right: auto;
        ...
        <div class="padding-vertical padding-xhuge">
          <div class="margin-bottom margin-medium">
            <div class="text-align-center">
              <h2 data-w-id="9ffab59e-7706-d2be-ebf0-c06419292ec7" style="opacity:0" class="max-width-mobile"> @if(isset($page->Text[4]->text)){!! $page->Text[4]->text !!}@endif
                </h2>
            </div>
          </div>
          <div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
            <div class="carousel-inner">
                @for ($i = 1; $i <= $page->Reviewer->count(); $i++ )
                        ...
                        <div class="row mx-auto"style="background-color: white; padding: 50px 0;">
                            <div class="col-7">
                                <div style="
                                  ...
                                  <div style="margin:auto;" class="paragraph-2">@if(isset($page->Reviewer->skip($i-1)->first()->text)){!! $page->Reviewer->skip($i-1)->first()->text !!}@endif</div>
                                </div>
                            </div>
                            <div class="col-1">
                            ...
                            <div class="col-2">
                                <div class=""><img src="@if (isset($page->Reviewer->skip($i-1)->first()->img)){{ '/storage/' . $page->Reviewer->skip($i-1)->first()->img }}@endif" class="testimonials1_client-image" alt="..."    style = "margin-left: 35%"></div>
                                <div class="testimonial1_name text-center">@if(isset($page->Reviewer->skip($i-1)->first()->nama)){!! $page->Reviewer->skip($i-1)->first()->nama !!}@endif</div>
                                <div class="paragraph-2 text-center">@if(isset($page->Reviewer->skip($i-1)->first()->role)){!! $page->Reviewer->skip($i-1)->first()->role !!}@endif</div>
                            </div>
                          </div>
                </div>
                </div>
    ...
    <div class="section-review" style="">
      ...
      <div class="container-large">
        <div class="padding-vertical padding-xhuge">
          <div class="margin-bottom margin-medium">
            <div class="text-align-center">
              <h2 data-w-id="9ffab59e-7706-d2be-ebf0-c06419292ec7" style="opacity:0.75" class="max-width-mobile">@if(isset($page->Text[5]->text)){!! $page->Text[5]->text !!}@endif
                </h2>
            </div>
          </div>
          <img src="@if (isset($page->Gambar->where('background', 2)->skip(0)->first()->img)){{ '/storage/' . $page->Gambar->where('background', 2)->skip(0)->first()->img }}@endif" alt="...">
        </div>
      </div>
        </div>
    </div>
    ...
    <div class="page-padding" style = "
      ...
      <div class="container-large">
        <div class="padding-vertical padding-xhuge">
          <div class="margin-bottom margin-medium">
            <div class="text-align-center">
              <h2 data-w-id="9ffab59e-7706-d2be-ebf0-c06419292ec7" style="font-style: italic; opacity:0" class="max-width-mobile">@if(isset($page->Text[6]->text)){!! $page->Text[6]->text !!}@endif
                </h2>
            </div>
          </div>
          <div data-delay="6000" data-animation="slide" class="slider desktop w-slider" data-autoplay="true" data-easing="ease-out" data-hide-arrows="false" data-disable-swipe="false" data-autoplay-limit="0" data-nav-spacing="4" data-duration="500" data-infinite="true">
            ...
            @for ($i=1; $i<=$page->Gambar->where('background',2)->count()/4;$i++)
                        ...
                        <div class="w-dyn-list">
                            ...
                            <div role="listitem" class="w-dyn-item">
                                ...
                                <div class="testimonials1_content">
                                    <img src="@if (isset($page->Gambar->where('background', 2)->skip($i-1)->first()->img)){{ '/storage/' . $page->Gambar->where('background', 2)->skip($i-1)->first()->img }}@endif" alt="...">
                                    </div>
                                </div>
                            </div>
                            @endfor
      ...
      <div data-delay="6000" data-animation="slide" class="slider mobile w-slider" data-autoplay="true" data-easing="ease-out" data-hide-arrows="false" data-disable-swipe="false" data-autoplay-limit="0" data-nav-spacing="4" data-duration="500" data-infinite="true">
        <div class="gallery_mask w-slider-mask">
            ...
            @for ($i=0; $i<$page->Gambar->where('background',2)->count(); $i++)
            <div class="gallery_slide w-slide">
                <div class="w-dyn-list">
                  <div role="list" class="slider-wrapper w-dyn-items">
                    <div role="listitem" class="w-dyn-item">
...
<div style="background-image: url('@if (isset($page->Gambar->where('background', 1)->skip(2)->first()->img)){{ '/storage/' . $page->Gambar->where('background', 1)->skip(2)->first()->img }}@endif'); background-size: cover; background-position:center;">
          ...
          <div class="padding-vertical padding-xhuge">
              <div class="margin-bottom margin-xlarge">
                <div class="text-align-center">
                  ...
                  margin: auto;
                  line-height: 110%;
                  padding-bottom: 2%;"><span style="color:white">@if(isset($page->Text[7]->text)){!! $page->Text[7]->text !!}@endif</span></h1>
                </div>
                ...
                <div class = "container">
                    ...
                    @for ($i=0; $i<$page->Gambar->where('background',4)->count(); $i++)
                    <div style="background-color: #ffde3e; margin-bottom: 15px;">
                        ...
                        <div class = "row" style="padding-bottom: 15px">
                            <div class = "col-1" style="max-width: 7%;margin-bottom: auto;margin-right: auto;margin-left: auto;margin-top: 20px;">
                                <div class="testimonials1_client-image-wrapper" style="border-radius: 0; margin:auto;"><img style="border-radius: 0; max-height:55px; width:auto" src="@if (isset($page->Gambar->where('background', 4)->skip($i)->first()->img)){{ '/storage/' . $page->Gambar->where('background', 4)->skip($i)->first()->img }}@endif" loading="lazy" alt="" sizes="(max-width: 991px) 100vw, 72px" class="testimonials1_client-image img-fluid" /></div>
                            </div>
                            <div class = "col">
                                <p>
                                <button style="
                                ...
                                <div class = "testimonial1_name">
                                    @if(isset($page->Text[8+($i*3)]->text)){!! $page->Text[8+($i*3)]->text !!}@endif
                                </div>
                                <div class = "paragraph-2">@if(isset($page->Text[9+($i*3)]->text)){!! $page->Text[9+($i*3)]->text !!}@endif</div>
                        </div>
                        <div style="margin-top:15px" class="collapse" id="toggle{{ $i }}">
                            <div class="card card-body" style="    margin: auto;
                            margin-right: 10px;">
                             @if(isset($page->Text[10+($i*3)]->text)){!! $page->Text[10+($i*3)]->text !!}@endif
                            </div>
                          </div>
                    </div>
                    </div>
