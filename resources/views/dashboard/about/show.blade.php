...
<header>
    <div style="background-image: url('{{ $about->Aboutjudul[0]->Aboutgambar[0]->load('Aboutjudul')->img }}'); background-size: cover; background-position:center; padding-bottom: 150px;">
                    ...
                    <div id="w-node-c3733106-a61e-156e-654f-c21c9b4597c1-2897c137" class="homepage-header_content-wrapper" style="max-width: 100%;">
                      <div class="homepage-header_content" style="max-width: 100%;">
                        <div data-w-id="5fb4b4db-d69c-5d88-8c1a-2cd78f94baf3" style="max-width: 100%; opacity:0;-webkit-transform:translate3d(0, 60px, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0);-moz-transform:translate3d(0, 60px, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0);-ms-transform:translate3d(0, 60px, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0);transform:translate3d(0, 60px, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0)" class="homepage-header_heading-wrapper">
                          <h1 class="homepage_header_heading" style="font-size: 55px; max-width: 100%;"><span style="color:white; font-family: 'MontserratSemiBold';" >{!! $about->Aboutjudul[0]->judul !!}</span></h1>
                        </div>
                ...
                <div class="padding-vertical padding-xhuge">
                    <div class="margin-bottom margin-xlarge">
                      <div class="text-align-center" style="margin: 0 6%;">
                        <h2 class="homepage_header_heading text-center"><span style="color:black">{{ $about->Aboutjudul[1]->judul }}</span></h2>
        ...
        <div>
            <div class="section-review" style="background-image: url('{{ $about->Aboutjudul[2]->Aboutgambar->load('Aboutjudul')->where('background',1)[0]->img }}'); background-size: cover; background-position:center;">
                <div class="page-padding" style = "
                width: 100%;
                max-width: 77rem;
                margin-right: auto;
                ...
                <div class="padding-vertical padding-xhuge">
                  <div class="margin-bottom margin-medium">
                    <div class="text-align-center">
                      <h2 data-w-id="9ffab59e-7706-d2be-ebf0-c06419292ec7" style="opacity:0" class="max-width-mobile">{{ $about->Aboutjudul[2]->judul }}
                        </h2>
                    </div>
                  </div>
                    ...
                    <div class="carousel-inner">
                        @for ($i = 1; $i <= $about->Aboutjudul[2]->Aboutgambar->load('Aboutjudul')->where('background',0)->count(); $i++ )
                            ...
                            <div class="container mx-auto" style="margin-left: 15%;">
                                <div class="testimonial10_quote-wrapper-inside"><img src="/Assets/20220908_160838_0000.png" loading="lazy" alt="" class="testimonial1_quote-icon" /></div>
                                <div class="testimonial1_quote-wrapper-inside" style="right: 35%; top: auto; left:auto; bottom:0%; transform:scaleX(-1)"><img src="/Assets/20220908_160838_0000.png" loading="lazy" alt="" class="testimonial1_quote-icon" /></div>
                                <div class="row mx-auto border border-4 border-gray"style="background-color: white; padding: 50px 0;">
                                    <div class="col-7">
                                        <div style="
                                            display: table-cell;
                                            padding: 10px;
                                          ...
                                          <div style="margin:auto;" class="paragraph-2">{{ $about->Aboutjudul[2]->Aboutgambar->load('Aboutjudul', 'Aboutreview')->where('aboutreview_id',$i)[$i]->Aboutreview->text }}</div>
                                        </div>
                                    </div>
                                    <div class="col-1">
                                    ...
                                    <div class="col-2">
                                        <div class=""><img src="{{ $about->Aboutjudul[2]->Aboutgambar->load('Aboutjudul', 'Aboutreview')->where('aboutreview_id',$i)[$i]->img }}" class="testimonials1_client-image" alt="..."    style = "display:block;margin:auto;"></div>
            ...
            <div class="section-review" style="">
              ...
              <div class="container-large">
                <div class="padding-vertical padding-xhuge">
                  <div class="margin-bottom margin-medium">
                    <div class="text-align-center">
                      <h2 data-w-id="9ffab59e-7706-d2be-ebf0-c06419292ec7" style="opacity:0.75" class="max-width-mobile">{{ $about->Aboutjudul[3]->judul }}
                        </h2>
                    </div>
                  </div>
                  <img src="/Assets/Copy of indo-blue.png" alt="...">
                </div>
              </div>
                </div>
            </div>
            ...
            <div class="page-padding" style = "
              ...
              <div class="container-large">
                <div class="padding-vertical padding-xhuge">
                  <div class="margin-bottom margin-medium">
                    <div class="text-align-center">
                      <h2 data-w-id="9ffab59e-7706-d2be-ebf0-c06419292ec7" style="font-style: italic; opacity:0" class="max-width-mobile">{{ $about->Aboutjudul[4]->judul }}
                        </h2>
                    </div>
                  </div>
                  <div data-delay="6000" data-animation="slide" class="slider desktop w-slider" data-autoplay="true" data-easing="ease-out" data-hide-arrows="false" data-disable-swipe="false" data-autoplay-limit="0" data-nav-spacing="4" data-duration="500" data-infinite="true">
                    ...
                    @for ($i=1; $i<=$about->Aboutjudul[4]->Aboutgambar->load('Aboutjudul')->where('background',0)->count()/4;$i++)
              ...
              <div data-delay="6000" data-animation="slide" class="slider mobile w-slider" data-autoplay="true" data-easing="ease-out" data-hide-arrows="false" data-disable-swipe="false" data-autoplay-limit="0" data-nav-spacing="4" data-duration="500" data-infinite="true">
                <div class="gallery_mask w-slider-mask">
                    ...
                    @for ($i=0; $i<$about->Aboutjudul[4]->Aboutgambar->load('Aboutjudul')->where('background',0)->count(); $i++)
                    <div class="gallery_slide w-slide">
                        <div class="w-dyn-list">
                          <div role="list" class="slider-wrapper w-dyn-items">
                            <div role="listitem" class="w-dyn-item">
        ...
        <div style="background-image: url('{{ $about->Aboutjudul[5]->Aboutgambar[0]->load('Aboutjudul')->img }}'); background-size: cover; background-position:center;">
